        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => window.location.href = '/'}>
              <div className="bg-gradient-to-br from-primary to-accent-blue p-2.5 rounded-lg shadow-lg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed max-w-lg">
                AI-powered call analysis platform that turns conversations into insights. 
                Automate call reviews, analyze sentiment, and accelerate sales growth with data-driven intelligence.
              </p>
      ...
      <section className="px-8 py-32 bg-card">
        <div className="mx-auto max-w-7xl">
          <div className="mb-20">
            ...
            <h2 className="text-5xl font-bold mb-6 tracking-tight">AI-Powered Sales Intelligence</h2>
            <p className="text-lg text-muted-foreground max-w-2xl leading-relaxed">
              Automate call analysis so your team can focus on what matters: closing deals.
            </p>
          </div>
      ...
      <section className="bg-secondary px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold mb-6">Why Teams Choose GrowthLens?</h2>
              <p className="text-xl text-muted-foreground mb-8">
                Join thousands of sales professionals who have transformed their performance with our AI-powered platform.
              </p>
              <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Card className="text-center p-6 border-2 hover:border-primary transition-colors">
                ...
                <div className="text-muted-foreground">Sales Pros</div>
              </Card>
              <Card className="text-center p-6 border-2 hover:border-accent-blue transition-colors">
                <div className="text-3xl font-bold text-accent-blue mb-2">1,200+</div>
